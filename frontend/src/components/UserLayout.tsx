...
const UserLayout: React.FC<UserLayoutProps> = ({ children, title }) => {
  ...
  const navItems = [
    { path: '/dashboard', label: t('nav.userDashboard'), icon: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6' },
  ...
  const visibleNavItems = user?.role === 'admin'
    ? [
        ...navItems,
        {
          ...
          icon: 'M4 5a2 2 0 012-2h4a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2V5zm10 0a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2V5zM4 15a2 2 0 012-2h4a2 2 0 012 2v4a2 2 0 01-2 2H6a2 2 0 01-2-2v-4z',
        },
      ]
    : navItems;
          ...
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center space-x-4">
              ...
              <div className="flex items-center text-sm text-gray-600">
                ...
                <span className="rounded-full border border-[#ead7cd] bg-[#fff8f3] px-2.5 py-1 text-xs font-medium text-[#8f5b4b]">
